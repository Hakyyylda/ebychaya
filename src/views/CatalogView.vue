  ...
  <div>
    <div style="background:#7c3aed;color:#fff;padding:30px 0;text-align:center;">
      <div class="container">
        ...
        <input v-model="query" type="text" placeholder="Поиск..." style="padding:10px 15px;border:none;border-radius:6px;width:300px;font-size:14px;">
    ...
    <div style="padding:30px 0;">
      <div class="container">
        <div v-for="game in filtered" :key="game.slug" class="hover-up" style="background:#fff;border:1px solid #e0e0e0;border-radius:8px;padding:15px;margin-bottom:15px;display:flex;gap:15px;">
        ...
        <p v-if="!filtered.length" style="text-align:center;color:#999;padding:30px;">Ничего не найдено.</p>
      </div>
    </div>
  </div>
</template>
