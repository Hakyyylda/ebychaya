  ...
  <div>
    ...
    <div style="padding:30px 0;">
      <div class="container" style="display:flex;gap:20px;justify-content:center;">
        <div v-for="p in promos" :key="p.game.slug" class="hover-up" style="background:#fff;border:1px solid #e0e0e0;border-radius:8px;padding:15px;width:300px;">
          ...
          <p style="font-size:13px;color:#999;text-decoration:line-through;">{{ formatPrice(p.oldPrice) }}</p>
          ...
          <span v-else style="color:#999;">В корзине</span>
        </div>
      </div>
    </div>
  </div>
