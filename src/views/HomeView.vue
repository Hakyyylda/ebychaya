  ...
  <div>
    <div style="background:#7c3aed;color:#fff;padding:50px 0;text-align:center;">
      <div class="container">
        ...
        <a href="/catalog" class="hover-up" style="background:#2a2a3e;color:#667eea;padding:12px 30px;border-radius:6px;font-weight:bold;text-decoration:none;margin-right:10px;">Смотреть каталог</a>
    ...
    <div style="padding:30px 0;">
      <div class="container">
        ...
        <div v-for="game in games" :key="game.slug" class="hover-up" style="background:#2a2a3e;border:1px solid #3a3a4e;border-radius:8px;padding:15px;margin-bottom:15px;display:flex;gap:15px;">
